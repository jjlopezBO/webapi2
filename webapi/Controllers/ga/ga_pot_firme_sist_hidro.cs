...
namespace cndcAPI.Controllers.ga
{
    [ApiController]
    [Route("[controller]")]
    public class ga_pot_firme_sist_hidro : Controller
    {
        private readonly ILogger<ga_pot_firme_sist_hidro> _logger;

        public ga_pot_firme_sist_hidro(ILogger<ga_pot_firme_sist_hidro> logger)
        {
            _logger = logger;
        }

        [HttpGet(Name = "ga_pot_firme_sist_hidro")]
        public async Task<IActionResult> GetAsync(string periodo, string subperiodo)
        {
            try
            {
                _logger.LogInformation("Iniciando pot_firme_sist_hidro...");
                ...
                {
                    table = await oracle.ExecuteAsync("pkg_apiga.ga_pot_firme_sist_hidro", periodoLong, subperiodoLong);
                }
                ...
                _logger.LogInformation("Consulta de ga_pot_firme_sist_hidro completada con éxito.");
